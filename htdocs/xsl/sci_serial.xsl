				...
				<div class="row">
					...
					<div class="col-12 col-lg-3 pt-lg-5 pb-4">
						<div class="list-group d-print-none mb-5">
							...
							<a class="list-group-item" href="/revistas/{/SERIAL/TITLEGROUP/SIGLUM}/{$pref}aboutj.htm"><svg class="journal-side-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M8 6h13"/><path d="M8 12h13"/><path d="M8 18h13"/><path d="M3 6h.01"/><path d="M3 12h.01"/><path d="M3 18h.01"/></svg> <xsl:call-template name="SERIAL_UI_TEXT"><xsl:with-param name="key">editorial_policy</xsl:with-param></xsl:call-template></a>
